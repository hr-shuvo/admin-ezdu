...
const QuizzesPage = () => {
    ...
    useEffect(() => {
        ...
        startTransition(async () => {
            const result = await quizService.getList(pagination.pageNumber, pagination.pageSize, sorting.orderBy, sorting.sortBy, debouncedSearchQuery, debouncedWithDeleted);
            console.log(result);
    ...
    return (
        <Card className=''>
            ...
            <CardContent>
                <DataTable
                    columns={quizColumns(refreshData)}
                    data={data}
                    loading={isPending}
                    pagination={{
