        ...
        async function loadData() {
            ...
            try {
                if (params.id) {
                    ...
                    setClassId(data.subject.classId);
        ...
        <div className="p-6">
            <div className="mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card className="lg:col-span-2">
                    <CardHeader>
                        <CardTitle className="text-2xl">Update Lesson</CardTitle>
                        <CardDescription>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="space-y-4 text-sm text-muted-foreground">
                            <p>
                                Use this form to update this academic lesson. Fill in the lesson name, select the
