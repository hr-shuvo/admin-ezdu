...
const SubjectsPage = () => {
    ...
    useEffect(() => {
        ...
        startTransition(async () => {
            const result = await subjectService.getList(pagination.pageNumber, pagination.pageSize, sorting.orderBy, sorting.sortBy, debouncedSearchQuery, debouncedWithDeleted);
            // console.log(result);
    ...
    return (
        <Card>
            ...
            <CardContent>
                ...
                <DataTable
                    columns={subjectColumns(refreshData)}
                    data={data}
                    loading={isPending}
                    pagination={{
