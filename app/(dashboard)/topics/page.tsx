...
const TopicsPage = () => {
    ...
    useEffect(() => {
        ...
        startTransition(async () => {
            const result = await topicService.getList(pagination.pageNumber, pagination.pageSize, sorting.orderBy, sorting.sortBy, debouncedSearchQuery, debouncedWithDeleted);
            // console.log(result);
