...
export default function TopicContentDetails() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                if (params.id) {
                    const response = await topicContentService.get(Number(params.id));
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <p className="text-lg font-semibold">{data.topic.name}</p>
                                        <Link
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <p className="text-lg font-semibold">{data.topic.subject.name}</p>
                                        <Link
                                            href={`/subjects/${data.topic.subject.id}`}
                                            className="text-blue-500 hover:text-blue-700 transition-colors"
                                            title="View Subject"
                                        >
                                            <ExternalLink className="w-4 h-4"/>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <p className="text-lg font-semibold">{data.topic.lesson.name}</p>
                                        <Link
                                            href={`/subjects/${data.topic.lesson.id}`}
                                            className="text-blue-500 hover:text-blue-700 transition-colors"
                                            title="View Lesson"
                                        >
                                            <ExternalLink className="w-4 h-4"/>
